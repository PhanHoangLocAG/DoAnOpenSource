...
class SanPhamController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $soluong = ChiTietHoaDon::getHoaDon($id);
        if(Count($soluong) == 0){
            $temp = 0;
        }else{
            $temp = $soluong[0]->soluong;
        }
      //  dd($temp);
        return view('frontend.sanpham.detailProduct',['sanpham'=>$sanpham,'mausac'=>$mausac,'branch'=>$branch,'binhluan'=>$binhluan,'soluong'=>$temp]);
    }
